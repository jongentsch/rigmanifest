...
smoke_response="$(printf '%s\n' '{"id":"portable-smoke","method":"chirp_runtime_status","params":{"required_driver_references":["Quansheng_UV-K5_egzumer"]}}' | "$tauri_sidecar" --once)"
...
if (payload.get("id") != "portable-smoke"
