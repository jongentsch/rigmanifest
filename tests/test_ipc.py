...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"id": "bad", "method": "import_chirp_image"},
        {"id": "bad", "method": "import_chirp_image", "params": {}},
        {"id": "bad", "method": "import_chirp_image", "params": {"source_path": "radio.img"}},
        {"id": "bad", "method": "import_chirp_image", "params": {"source_path": "radio.img", "database_path": "workspace.sqlite3"}},
        {"id": "bad", "method": "list_radio_images"},
        {"id": "bad", "method": "list_radio_images", "params": {}},
        {"id": "bad", "method": "list_radio_images", "params": {"database_path": "workspace.sqlite3"}},
        {"id": "bad", "method": "compile", "params": {"radio_id": "radio-1", "database_path": "workspace.sqlite3", "profile": "home"}},
        {"id": "bad", "method": "compile", "params": {"radio_id": "radio-1", "database_path": "workspace.sqlite3", "profiles": []}},
        {"id": "bad", "method": "compile", "params": {"radio_id": "radio-1", "database_path": "workspace.sqlite3", "profiles": [], "user_frequency_definitions": [], "user_frequency_sets": [], "output_path": 1}},
        {"id": "bad", "method": "compile", "params": {"target": "yaesu-vx6r", "profile": "home", "additional_frequency_set_ids": [""]}},
        {"id": "bad", "method": "compile", "params": {"target": "yaesu-vx6r", "profile": "home", "additional_frequency_definition_ids": "bad"}},
        {"id": "bad", "method": "compile", "params": {"target": "yaesu-vx6r", "profile": "home", "advisory_plan_id": ""}},
        {"id": "bad", "method": "compile", "params": {"target": "yaesu-vx6r", "profile": "home", "use_factory_sets": "yes"}},
    ],
)
